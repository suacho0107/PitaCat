...
public class PlotManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        fm = transform.parent.GetComponent<FarmManager>();  // FarmManager 컴포넌트를 상위 컴포넌트로
    ...
    void Update()
    {
        if (isPlanted && !isDry)
        {
            timer -= speed * Time.deltaTime;    // speed 변수 곱함
    ...
    void Harvest()
    {
        ...
        fm.Transaction(selectedPlant.sellPrice);     // getting money
        isDry = true;
        plot.sprite = drySprite;
        speed = 1;
    }
    ...
    void Plant(PlantObject newPlant)
    {
        ...
        fm.Transaction(-selectedPlant.buyPrice);    // paying money
